...
namespace EL.Server.Controllers
{
    ...
    public class AccountController : GenericController
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                if (Roles.IsUserInRole(model.Email, RoleType.Administrator.ToString()))
        ...
        public ActionResult Register(RegisterModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    model.RegistrationDate = DateTimeOffset.Now;
                    ...
                    //if (!Roles.GetRolesForUser(model.UserName).Contains(RoleType.Administrator.ToString()))
                    Roles.AddUsersToRole(new []{model.Email}, RoleType.Administrator.ToString());
